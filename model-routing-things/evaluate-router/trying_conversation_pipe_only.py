...
path_to_checkpoint = "/data/user_data/sophiapi/checkpoints/stupid_consistent_qwen3_router_model-5_instance-100_max-length-16384_samples-20000/checkpoint-4500"
# Give examples from the validation set
path_to_validation_set = "/home/sophiapi/model-routing/OpenHands/evaluation/evaluation_outputs/datasets/model-5_instance-100_with-ids_swe-gym_consistent_cleaned_no-oh-prompt_partial-trajectories_2025-08-30T19-46-44/20000-samples/20250831_141405_val_chat-template-v2_max-len-16384.jsonl"
...
with open(path_to_validation_set, "r") as f:
    ...
    for i, line in enumerate(selected_lines):
        ...
        response = pipe(example['prompt'], max_new_tokens=50, tokenizer=tokenizer)
